---
name: evidence-linked-learning-design
description: Design lessons or training from observable learning goals, prerequisite evidence, accessible practice, and aligned assessment.
---

# Evidence-linked learning design

Turn a lesson, course unit, or workplace training request into a learning experience whose success can be observed. Prefer a usable teaching artifact over a long description of pedagogy.
...
Return the learner-facing goal, success criteria, timed sequence, facilitator cues, practice task, assessment with scoring guidance, supports and extension. For a course, add a prerequisite map and a cumulative assessment rather than repeating isolated lessons.

Check that every goal is practiced and assessed, and that every assessment has a defensible expected answer or rubric. Audit language load, contrast, captions, keyboard access and equivalent participation where relevant. Avoid collecting identifiable student data unless needed and authorized.

Example: if the goal is to compare two explanations using evidence, a vocabulary quiz alone is insufficient. Give a short unfamiliar example, ask the learner to choose and justify an explanation, and score the quality of the evidence link.

A well-designed plan is not evidence that learning occurred. After teaching, compare actual learner work with the criteria and revise the missed mechanism. Do not infer ability, disability or motivation from a single response.
