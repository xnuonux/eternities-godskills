...
Preserve meaningful zero, false, empty and missing values distinctly. For text,
specify whether nonempty means positive length or nonblank after normalization;
do not leave that distinction implicit between producer and consumer. Use an
